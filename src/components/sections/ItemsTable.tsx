          ...
          <table className="w-full text-sm text-left">
            ...
            <tbody className="divide-y divide-gray-100">
              {items.length === 0 ? (
                ...
                items.map((item, index) => (
                  <tr key={index} className="hover:bg-tf-yellow/5 transition-colors group">
                    <td className="px-4 py-3">
                      <textarea 
                        className="w-full bg-transparent border border-transparent focus:border-tf-yellow focus:bg-white rounded-lg outline-none py-2 px-2 resize-y min-h-[40px] text-gray-700 transition-colors"
                    ...
                    <td className="px-4 py-3 align-top">
                      <input 
                        className="w-full bg-transparent border-b border-transparent focus:border-tf-yellow outline-none py-1 text-center text-xs text-gray-500"
                    ...
                    <td className="px-4 py-3 align-top">
                      <input 
                        type="number"
                        className="w-full bg-transparent border-b border-transparent focus:border-tf-yellow outline-none py-1 text-center text-gray-700"
                        value={item.quantity}
                    ...
                    <td className="px-4 py-3 align-top">
                      <input 
                        className="w-full bg-transparent border-b border-transparent focus:border-tf-yellow outline-none py-1 text-center uppercase text-xs text-gray-500"
                        value={item.unit || ''}
                    ...
                    <td className="px-4 py-3 align-top">
                      <input 
                        type="number"
                        className="w-full bg-transparent border-b border-transparent focus:border-tf-yellow outline-none py-1 text-right text-gray-700"
                    ...
                    <td className="px-4 py-3 align-top">
                      <input 
                        type="number"
                        className="w-full bg-transparent border-b border-transparent focus:border-tf-yellow outline-none py-1 text-right font-semibold text-gray-900"
                        value={item.amount}
            ...
            {items.length > 0 && (
              <tfoot className="bg-gray-50 font-bold text-xs">
                <tr>
                  <td colSpan={5} className="px-4 py-4 text-right text-gray-500 uppercase tracking-wide">
                    Suma Conceptos:
                  </td>

...
export const PaymentProgramSelector: React.FC<PaymentProgramSelectorProps> = ({
  ...
  return (
    <div className="space-y-5">
      ...
      {/* Info Banner */}
      <div className="flex items-start gap-3 p-4 bg-tf-yellow/10 rounded-xl border border-tf-yellow/20">
        <Info size={18} className="text-tf-yellow-accent flex-shrink-0 mt-0.5" />

    ...
    <div className="space-y-5">
      ...
      <div className="card p-4">
        ...
        {formData.certificationDate && (
          <p className="text-xs text-tf-yellow-accent mt-2 ml-0.5 flex items-center gap-1.5">
            <span className="w-1.5 h-1.5 bg-tf-yellow rounded-full"></span>
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex gap-4 items-center">
            <label className={`flex items-center gap-2 cursor-pointer ${readOnly ? 'pointer-events-none' : ''}`}>
              <input 
                ...
                disabled={readOnly}
                className="w-4 h-4 text-tf-yellow accent-tf-yellow"
              />
          ...
          <div className="mt-2 text-sm font-semibold p-3 rounded-xl bg-gray-50">
            {formData.paymentMethod === 'PUE' && (
              <span className="text-tf-yellow-accent flex items-center gap-2">
        ...
        {(showRetentionIva || showRetentionIsr) && (
          <div className="border-t border-gray-100 pt-4 space-y-3">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-1 text-[10px] bg-tf-yellow/10 text-tf-yellow-accent px-2 py-1 rounded-full">
            ...
            <select 
              className={`w-full rounded-xl py-2.5 px-3 outline-none transition-all duration-200 border-2
                ${readOnly 
                  ...
                  : 'bg-white border-gray-200 text-gray-900 focus:border-tf-yellow'
                }
              `}

  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <div className="relative group">
        ...
        {selectedProject && (
          <div 
            className="absolute left-3 top-1/2 -translate-y-1/2 w-3 h-3 rounded-full border-2 border-white dark:border-tf-charcoal shadow-sm z-10"
        ...
        <select
          ...
          className={`
            ...
            ${isLocked
              ? 'bg-gray-100 dark:bg-tf-black/50 border-2 border-gray-200 dark:border-tf-gray-dark text-gray-500 dark:text-gray-500 cursor-default'
              : 'bg-white dark:bg-tf-charcoal border-2 border-gray-200 dark:border-tf-gray-dark text-gray-900 dark:text-white hover:border-gray-300 dark:hover:border-tf-yellow/30 focus:border-tf-yellow focus:ring-2 focus:ring-tf-yellow/20 cursor-pointer'
            }
        ...
        <div className={`absolute inset-y-0 right-0 flex items-center px-3 pointer-events-none transition-colors duration-200
          ${isLocked ? 'text-gray-400' : 'text-gray-500 dark:text-gray-400 group-focus-within:text-tf-yellow'}
        `}>
          <ChevronDown size={18} />
        </div>
      </div>

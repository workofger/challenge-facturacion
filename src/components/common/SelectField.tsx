  ...
  <div className={`flex flex-col gap-1.5 ${className}`}>
    ...
    <div className="relative group">
      <select
        ...
        className={`
          ...
          ${disabled 
            ...
            : 'bg-white dark:bg-tf-charcoal border-2 border-gray-200 dark:border-tf-gray-dark text-gray-900 dark:text-white hover:border-gray-300 dark:hover:border-tf-yellow/30 focus:border-tf-yellow focus:ring-2 focus:ring-tf-yellow/20'
          }
        `}
      >
      ...
      <div className={`absolute inset-y-0 right-0 flex items-center px-3 pointer-events-none transition-colors duration-200
        ${disabled ? 'text-gray-400' : 'text-gray-500 dark:text-gray-400 group-focus-within:text-tf-yellow'}
      `}>
        <ChevronDown size={18} />
      </div>
    </div>

...
const alertConfig = {
  ...
  success: {
    icon: CheckCircle,
    bg: 'bg-tf-yellow/10',
    border: 'border-tf-yellow/30',
    iconColor: 'text-tf-yellow-accent',
    titleColor: 'text-tf-black',
    messageColor: 'text-tf-black/80',
    buttonBg: 'bg-tf-yellow hover:bg-tf-yellow-dark text-tf-black',
  },
  info: {
    icon: Info,
    bg: 'bg-blue-50',

    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-lg bg-white border border-amber-200 rounded-2xl shadow-2xl overflow-hidden animate-scale-in">
        ...
        <div className="p-6 space-y-4">
          ...
          {/* What happens next */}
          <div className="bg-tf-yellow/10 border border-tf-yellow/30 rounded-xl p-4">
            <h3 className="text-tf-black font-semibold mb-3 flex items-center gap-2">
              <ChevronRight className="w-4 h-4 text-tf-yellow-accent" />
              ¿Qué pasará con mi factura?
            </h3>
            <ul className="text-gray-700 text-sm space-y-2.5">
              <li className="flex items-start gap-3">
                <FolderClock size={16} className="text-tf-yellow-accent mt-0.5 flex-shrink-0" />
                <span>Se guardará en la carpeta de <strong>Extemporáneas</strong></span>
              </li>
              <li className="flex items-start gap-3">
                <CalendarCheck size={16} className="text-tf-yellow-accent mt-0.5 flex-shrink-0" />
                <span>Se programará para el <strong>siguiente ciclo de pago</strong></span>
              </li>
              <li className="flex items-start gap-3">
                <Clock size={16} className="text-tf-yellow-accent mt-0.5 flex-shrink-0" />
        ...
        <div className="p-6 pt-0 flex gap-3">
          ...
          <button
            onClick={onConfirm}
            className="flex-1 py-3 px-4 bg-tf-yellow hover:bg-tf-yellow-dark text-tf-black font-bold rounded-xl shadow-lg shadow-tf-yellow/25 hover:shadow-tf-yellow/40 transition-all"
          >
            Entendido, continuar
          </button>
        </div>

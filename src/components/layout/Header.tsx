...
export const Header: React.FC = () => {
  ...
  return (
    <header className="relative bg-tf-yellow overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="relative max-w-6xl mx-auto px-4 py-8 pb-20">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className={`flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium ${
            afterDeadline 
              ...
              : 'bg-white/30 text-tf-black border border-white/50'
          }`}>
            <Clock size={16} />
        ...
        <div className="text-center max-w-2xl mx-auto">
          <h1 className="text-3xl md:text-4xl font-bold text-tf-black mb-4">
            Sube tu Factura
          </h1>
          <p className="text-tf-black/70 text-lg mb-6">
          ...
          <div className="flex items-center justify-center gap-4 md:gap-8 text-sm">
            <div className="flex items-center gap-2 text-tf-black/80">
            ...
            <div className="w-8 h-0.5 bg-tf-black/20"></div>
            <div className="flex items-center gap-2 text-tf-black/80">
              <div className="w-8 h-8 bg-white/40 rounded-full flex items-center justify-center">

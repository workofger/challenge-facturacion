...
const UserProfile: React.FC = () => {
  ...
  return (
    <UserLayout>
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-tf-black mb-2">Mi Perfil</h1>
        <p className="text-gray-500">Administra tu información personal y bancaria</p>
      </div>

      {/* Status Messages */}
      {success && (
        <div className="bg-tf-yellow/10 border border-tf-yellow/30 rounded-xl p-4 mb-6 flex items-center gap-3">
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-2xl border border-tf-gray-light p-6">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 bg-blue-100 rounded-xl flex items-center justify-center">
              <Building2 className="w-5 h-5 text-blue-600" />
            </div>
            <div>
              <h2 className="text-lg font-semibold text-tf-black">Información Fiscal</h2>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-tf-black font-mono bg-gray-50 px-4 py-3 rounded-xl">
                {user?.rfc || '-'}
              </p>
            </div>
            <div>
              <label className="block text-sm text-gray-500 mb-1">Nombre / Razón Social</label>
              <p className="text-tf-black bg-gray-50 px-4 py-3 rounded-xl">
                {user?.fiscal_name || '-'}
              </p>
            </div>
            <div>
              <label className="block text-sm text-gray-500 mb-1">Email</label>
              <div className="flex items-center gap-2 text-tf-black bg-gray-50 px-4 py-3 rounded-xl">
                <Mail className="w-4 h-4 text-gray-400" />
                {user?.email || '-'}
                {user?.email_verified && (
                  <CheckCircle className="w-4 h-4 text-tf-yellow-accent ml-auto" />
                )}
              </div>
            </div>
            <div>
              <label className="block text-sm text-gray-500 mb-1">Tipo de cuenta</label>
              <p className="text-tf-black bg-gray-50 px-4 py-3 rounded-xl capitalize">
        ...
        <div className="bg-white rounded-2xl border border-tf-gray-light p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-lg font-semibold text-tf-black">Información de Contacto</h2>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 bg-gray-50 border border-tf-gray-light rounded-xl text-tf-black focus:outline-none focus:ring-2 focus:ring-tf-yellow/50 focus:border-tf-yellow"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <textarea
                  ...
                  className="w-full pl-12 pr-4 py-3 bg-gray-50 border border-tf-gray-light rounded-xl text-tf-black focus:outline-none focus:ring-2 focus:ring-tf-yellow/50 focus:border-tf-yellow resize-none"
        ...
        {/* Bank Information */}
        <div className="bg-white rounded-2xl border border-tf-gray-light p-6 lg:col-span-2">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 bg-purple-100 rounded-xl flex items-center justify-center">
              <CreditCard className="w-5 h-5 text-purple-600" />
            </div>
            <div>
              <h2 className="text-lg font-semibold text-tf-black">Información Bancaria</h2>
              <p className="text-gray-500 text-sm">
                Para recibir tus pagos de forma segura
              </p>
            </div>
            {user?.bank_clabe && (
              <span className="ml-auto px-3 py-1 bg-tf-yellow/20 text-tf-yellow-accent text-xs rounded-full flex items-center gap-1 font-medium">
          ...
          {user?.bank_name && (
            <div className="bg-gray-50 rounded-xl p-4 mb-6">
              ...
              <div className="flex items-center gap-4">
                <div>
                  <p className="text-tf-black font-medium">{user.bank_name}</p>

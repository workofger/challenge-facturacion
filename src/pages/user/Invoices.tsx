...
const UserInvoices: React.FC = () => {
  ...
  return (
    <UserLayout>
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-tf-black mb-2">Mis Facturas</h1>
      ...
      {data?.summary && (
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          <div className="bg-white rounded-xl border border-tf-gray-light p-4">
            <p className="text-gray-500 text-sm">Total Facturas</p>
            <p className="text-xl font-bold text-tf-black">{data.total}</p>
          </div>
          <div className="bg-white rounded-xl border border-tf-gray-light p-4">
            <p className="text-gray-500 text-sm">Total Facturado</p>
            <p className="text-xl font-bold text-tf-yellow-accent">
      ...
      {/* Filters */}
      <div className="bg-white rounded-xl border border-tf-gray-light p-4 mb-6">
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-gray-50 border border-tf-gray-light rounded-xl text-tf-black placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-tf-yellow/50 focus:border-tf-yellow"
            />
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="px-3 py-2.5 bg-gray-50 border border-tf-gray-light rounded-xl text-tf-black focus:outline-none focus:ring-2 focus:ring-tf-yellow/50 focus:border-tf-yellow"
            >
          ...
          <>
            ...
            <div className="hidden lg:block overflow-x-auto">
              <table className="w-full">
                <thead>
                  <tr className="border-b border-tf-gray-light bg-gray-50">
                ...
                <tbody>
                  {filteredInvoices.map((invoice) => (
                    <tr
                      key={invoice.id}
                      className={`border-b border-tf-gray-light hover:bg-gray-50 transition-colors ${
            ...
            {data && data.totalPages > 1 && (
              <div className="flex items-center justify-between px-6 py-4 border-t border-tf-gray-light">

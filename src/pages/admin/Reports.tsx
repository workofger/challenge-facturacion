    ...
    <AdminLayout>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2">
          <div className="bg-tf-charcoal/50 backdrop-blur-xl rounded-2xl border border-gray-700/50 p-6">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 bg-tf-yellow/20 rounded-xl flex items-center justify-center">
                <FileSpreadsheet className="w-5 h-5 text-tf-yellow-accent" />
              </div>
              <div>
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 bg-tf-black/50 border border-gray-600/50 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-tf-yellow/50"
                    >
                  ...
                  <button
                    ...
                    className={`flex items-center justify-center gap-2 px-4 py-3 rounded-xl border transition-all ${
                      !filters.paymentProgram
                        ? 'bg-tf-yellow/20 border-tf-yellow/50 text-tf-yellow-accent'
                        : 'bg-tf-black/50 border-gray-600/50 text-gray-400 hover:text-white'
                    }`}
                  >
              ...
              {exportResult && (
                <div className={`p-4 rounded-xl flex items-center gap-3 ${
                  exportResult.success 
                    ? 'bg-tf-green/10 border border-tf-green/30' 
                    : 'bg-red-500/10 border border-red-500/30'
                }`}>
                  {exportResult.success ? (
                    <CheckCircle className="w-5 h-5 text-tf-green" />
                  ) : (
                    <XCircle className="w-5 h-5 text-red-400" />
                  )}
                  <span className={exportResult.success ? 'text-tf-green' : 'text-red-300'}>
              ...
              <button
                ...
                className="w-full py-4 bg-tf-yellow hover:bg-tf-yellow-dark text-tf-black font-semibold rounded-xl shadow-lg shadow-tf-yellow/25 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
              >
                {isExporting ? (
                  <>
        ...
        <div className="space-y-6">
            ...
            <ul className="space-y-2 text-sm">
              {[
                ...
                <li key={idx} className="flex items-center gap-2 text-gray-300">
                  <span className="w-1.5 h-1.5 bg-tf-yellow-accent rounded-full" />
                  {col}
                </li>
              ))}
            </ul>
          ...
          {/* Tips */}
          <div className="bg-tf-yellow/10 border border-tf-yellow/30 rounded-2xl p-6">
            <h3 className="text-tf-yellow-accent font-semibold mb-3">💡 Tip</h3>
            <p className="text-tf-yellow-accent/70 text-sm">
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 bg-tf-black/50 border border-gray-600/50 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50"
                    >
              ...
              {paymentExportResult && (
                <div className={`p-4 rounded-xl flex items-center gap-3 ${
                  ...
                  <span className={paymentExportResult.success ? 'text-tf-green' : 'text-red-300'}>

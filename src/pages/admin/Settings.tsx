    ...
    <AdminLayout>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                maxLength={18}
                className="w-full px-4 py-3 bg-tf-black/50 border border-gray-600/50 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-tf-yellow/50"
              />
            </div>
            ...
            {result && (
              <div className={`p-4 rounded-xl flex items-center gap-3 ${
                ...
                <span className={result.success ? 'text-tf-green' : 'text-red-300'}>
                  {result.message}
                </span>
              </div>
            )}
            ...
            <button
              ...
              disabled={isSaving}
              className="w-full py-3 bg-tf-yellow hover:bg-tf-yellow-dark text-tf-black font-semibold rounded-xl shadow-lg shadow-tf-yellow/25 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {isSaving ? (
                <>
        ...
        <div className="bg-tf-charcoal/50 backdrop-blur-xl rounded-2xl border border-gray-700/50 p-6">
          ...
          <div className="space-y-4">
            {/* Toggle Switch */}
            <div className="p-4 bg-tf-black/30 rounded-xl">
              <div className="flex items-center justify-between">
                ...
                >
                  {isSavingProntoPago ? (
                    ...
                    <ToggleRight className="w-10 h-10 text-tf-green cursor-pointer hover:opacity-80 transition-opacity" />
                  ) : (
            ...
            {prontoPagoResult && (
              <div className={`p-4 rounded-xl flex items-center gap-3 ${
                ...
                <span className={prontoPagoResult.success ? 'text-tf-green' : 'text-red-300'}>
            ...
            <div className={`p-4 rounded-xl text-center ${
              ...
              <span className={`font-semibold ${
                prontoPagoConfig.enabled ? 'text-tf-green' : 'text-gray-400'
              }`}>
        ...
        <div className="bg-tf-charcoal/50 backdrop-blur-xl rounded-2xl border border-gray-700/50 p-6 lg:col-span-2">
          <div className="flex items-center gap-3 mb-6">
